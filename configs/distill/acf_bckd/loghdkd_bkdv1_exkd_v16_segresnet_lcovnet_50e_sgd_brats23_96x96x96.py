...
with read_base():
    ...
    from ...segresnet.segresnet_50e_sgd_brats23_96x96x96 import model as teacher_model  # noqa
    from ...lcovnet.lcovnet_50e_sgd_brats23_96x96x96 import model as student_model  # noqa
    ...
    distiller=dict(
        ...
        student_recorders=dict(
            up_conv2=dict(
                ...
                source='segmentor.backbone.Decode_block4'),
        ...
        teacher_recorders=dict(
            up2=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.up_layers.2.0'),
            up_ru2=dict(type=ModuleOutputsRecorder, source='segmentor.backbone.up_layers.2.0.conv2'),
            logits=dict(type=ModuleOutputsRecorder, source='segmentor')
        ),
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='word', name='kd-unet-base-unet-tiny-1000e'),
        )
]
